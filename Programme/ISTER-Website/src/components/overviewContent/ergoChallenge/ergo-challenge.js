        ...
        return html`
            ...
            <div class="mainPos">
                <div style="margin-left:2%">
                    ...
                    <div style="margin-top:-24%;margin-left:35%;font-size:15px">
                        <h2><em>Allgmeines:</em></h2>
                        <p><em>Bei diesem Bewerb gibt es weder etwas zu gewinnen, noch erhält man eine Medaille.  Alle Ruderer, weiblich und männlich aus Vereinen oder privat, sind startberechtigt und als Administrator vertrauen wir auf die Richtigkeit der gelieferten Daten.</em></p>
                        <h2><em>Bewerb:</h2>
                        <p><em>Die Teilnehmer sollen versuchen in der Zeit von 30 Minuten so viele Meter am Ergometer zurück zu legen, als es ihnen möglich ist.  Es gibt über den Winter verteilt sechs (6) Termine, wobei die vier (4) besten Ergebnisse gewertet werden. Die Termine sind immer von Donnerstag 18:00 Uhr bis Montag 18:00 Uhr berechnet:</em></p>
                        <ul><em>
