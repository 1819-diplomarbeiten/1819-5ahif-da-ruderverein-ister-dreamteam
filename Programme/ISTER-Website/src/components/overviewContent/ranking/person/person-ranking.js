...
class PersonRanking extends LitElement{
    ...
    getDistances(){
        ...
        .then(data => {
            if(this.dropDownResult == '0' && this.dropDownSequence != 'Categories')
                ...
                this.createPdfParticular(data)
            else if(this.dropDownResult == '0' && this.dropDownSequence == 'Categories')
                this.createPdfTotalCategories(data)
            else
                this.createPdfParticularCategories(data)
        })
    }

    createPdfParticular(result){
        var doc = new jsPDF()
    ...
    createPdfTotalCategories(result){
        var doc = new jsPDF()
        var pageHeight = 290;
        var img = 'data:image/png;base64,'
        doc.setFontSize(18)
        ...
        for(var i = 0; i < result.length; i ++)
        {
            ...
            if(i != 0)
            tableLengthBefore = 9 * result[i - 1][1].length * i
            tableLengthBefore += 5
            var tableLengthActual = tableLengthBefore + (9 * (result[i][1].length + 4))
            if(tableLengthActual > pageHeight){
                doc.addPage();
                tableLengthBefore = 0
            }
            doc.autoTable(columns, rows, {
                margin: {top: tableLengthBefore + 30},
                columnStyles: {
                    fontSize:5 //funzt ned
                },
                tableWidth: 'auto'
    ...
    createPdfParticularCategories(result){
        var doc = new jsPDF()
        var pageHeight = 290;
        var img = 'data:image/png;base64,'
        doc.setFontSize(18)
