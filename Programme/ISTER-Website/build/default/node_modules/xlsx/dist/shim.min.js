...
if (!Object.keys) Object.keys = function () {
  ...
  return function (n) {
    ...
    for (var a in n) if (t.call(n, a)) o.push(a);

    if (e) for (var l = 0; l < i; ++l) if (t.call(n, r[l])) o.push(r[l]);
    return o;
  };
}();
if (!String.prototype.trim) String.prototype.trim = function () {
  ...
  for (var e = t.length - 1; e >= 0; --e) if (!t.charAt(e).match(/^\s/)) return t.slice(0, e + 1);
...
if (!Array.prototype.forEach) Array.prototype.forEach = function (t) {
  ...
  for (var i = 0; i < e; ++i) if (i in this) r ? t.call(r, this[i], i, this) : t(this[i], i, this);
};
if (!Array.prototype.map) Array.prototype.map = function (t) {
  ...
  for (var n = 0; n < e; ++n) if (n in this) i[n] = r ? t.call(r, this[n], n, this) : t(this[n], n, this);
...
if (!Array.prototype.indexOf) Array.prototype.indexOf = function (t) {
  ...
  for (r < 0 && (r += e) < 0 && (r = 0); r < e; ++r) if (this[r] === t) return r;
...
if (!Array.prototype.lastIndexOf) Array.prototype.lastIndexOf = function (t) {
  ...
  for (; r >= 0; --r) if (this[r] === t) return r;
...
if (typeof ArrayBuffer !== "undefined" && !ArrayBuffer.prototype.slice) ArrayBuffer.prototype.slice = function (t, e) {
  ...
  if (i.set) i.set(n);else while (t <= --e) i[e - t] = n[e];
  return r;
};
