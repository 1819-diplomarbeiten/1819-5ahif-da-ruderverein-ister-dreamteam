import { LitElement, html } from "../../../../../node_modules/@polymer/lit-element/lit-element.js"; //import '../../rest/dataService.js'
...
class PersonRanking extends LitElement {
  ...
  constructor() {
    super();
    this.path = 'http://localhost:8080/testclienttest/rs/sql/'; //this.email = 'E Mail';
  ...
  getDistances() {
    ...
    fetch(this.path + "bestFourDistancesParticipants/" + this.dropDownYear + "/" + this.dropDownResult + "/" + this.dropDownSequence, {
      ...
      if (this.dropDownResult == '0') this.createPdfTotal(data);else this.createPdfSingleRound(data);
    });
  }
  ...
  createPdfSingleRound(result) {
    ...
    var columns = [{
      ...
      title: "Round " + this.dropDownResult,
      dataKey: "round"
    }, {
      title: "",
      dataKey: "empty"
