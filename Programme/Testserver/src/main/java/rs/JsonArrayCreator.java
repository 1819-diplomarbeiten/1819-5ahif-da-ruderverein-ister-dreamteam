...
public class JsonArrayCreator {
    ...
    public JsonArray getKeyValueTranslation(String language){
        ...
        jsonGerman.add("headerCountdown", "DIE CHALLENGE")
                ...
                .add("ergoTextFour", "Um in die Reihung aufgenommen zu werden, benötige ich Geburtsjahr, Körpergewicht und ein Fotos des Monitors. Anschließend Übermittlung der Daten per E-mail an challenge@ister.at. Es können auch vereinsinterne Listen (30K Ergebnisse Liste) verwendet werden. Vertrauen steht im Vordergrund. Die Reihung erfolgt gemäß der Concept2 Alterseinteilung.")
                ...
                .add("clubRankingEmailDistanceBtn", "Lade Email-Name List")
                ...
                .add("clubRankingSequenceContent", "Alphabetisch;Top Down; Kategorien")
                ...
                .add("distanceClubSuccessThree", "Die Excel Datei wurde erfolgreich hochgeladen")
                ...
                .add("distanceParticipantSuccessThree", "Die Distanz wurde erfolgreich hochgeladen")
