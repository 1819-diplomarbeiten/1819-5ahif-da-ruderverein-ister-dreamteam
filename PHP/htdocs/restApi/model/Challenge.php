...
class Challenge
{
    ...
    function create(){
        ...
        SET
            challenge_id=:challenge_id, start_date=:start_date,end_date = (SELECT DATE_ADD(:start_date, INTERVAL 7 DAY ))";
    ...
    function update(){
        $query = "UPDATE challenge SET start_date = :start_date, end_date = (SELECT DATE_ADD(:start_date,INTERVAL 7 DAY)) WHERE challenge_id = :challenge_id";
